...
class Pikachu:
    ...
    def mouth(self, x, y):
        ...
        # Desenhando os Lábios inferiores
        l1 = []
        l2 = []
        t.seth(190)
        a = 0.7
        ...
        # Desenhando os lábios superiores
        t.seth(10)
        t.circle(50, 15)
        t.left(180)
        t.circle(-50, 15)
    ...
    # Desenhando as bochechas avermelhadas
    ...
    def body(self):
        ...
        t.fillcolor('#F6D02F')
        t.begin_fill()
        # fazendo o Contorno facial direito
        t.penup()
        t.circle(130, 40)
        t.pendown()
        t.circle(100, 105)
        ...
        # Contorno facial esquerdo
        t.seth(240)
        t.circle(105, 95)
        t.left(180)
        t.circle(-105, 5)

        # Desenhando a mão esquerda
        t.seth(210)
        t.circle(500, 18)
        t.seth(200)
        t.fd(10)
